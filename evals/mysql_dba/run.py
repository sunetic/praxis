...
def build_parser() -> argparse.ArgumentParser:
    """Build the MySQL suite command-line parser."""
    catalog = load_catalog(SUITE.catalog_path)
    parser = argparse.ArgumentParser(
        description="Run Praxis's local MySQL DBA reliability/intelligence eval."
    )
    add_common_arguments(
        parser,
        catalog,
...
def run(args: argparse.Namespace) -> int:
    """Execute the MySQL suite and return its classified exit code."""
